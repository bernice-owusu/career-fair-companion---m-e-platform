          ...
          {submitted ? (
            <div className="text-center py-8 space-y-4">
              ...
              <button
                ...
                className="w-full py-3.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm shadow-lg shadow-emerald-600/30 transition"
              >
                Back to Dashboard
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 space-y-2">
                ...
                <div className="flex items-center justify-between gap-2 pt-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <Star className={`w-5 h-5 ${overallRating >= star ? 'fill-amber-400 text-amber-400' : ''}`} />
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 space-y-2">
                ...
                <div className="flex items-center justify-between gap-2 pt-1">
                  {[1, 2, 3, 4, 5].map((level) => (
                    ...
                    >
                      <ThumbsUp className={`w-4 h-4 ${confidenceRating >= level ? 'text-indigo-400' : ''}`} />
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-4 space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2 bg-slate-900 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-amber-500 to-indigo-600 hover:from-amber-400 hover:to-indigo-500 text-slate-950 hover:text-white font-bold text-base shadow-xl transition flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
